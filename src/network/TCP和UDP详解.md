...
![TCP报文格式](TCP和UDP详解/tcp-message.png)
...
![MSS协商](TCP和UDP详解/tcp-12.png)

### 窗口控制
TCP 是以 1 个段为单位，每发一个段进行一次确认应答。如果包的往返时间越长，通信性能就越低。

![按数据包确认应答](TCP和UDP详解/tcp-13.png)
